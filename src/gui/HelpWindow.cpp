...
void HelpWindow::FillKeyboardShortcutsTable()
{
    _shortcuts = {
        ...
        {"Toggle Audio Level Indicator", "v"},
        ...
        {"Rate Current Preset 1-5", "1 / 2 / 3 / 4 / 5"},
        {"Quick-add to Favorites Playlist", "f"},
        {"Lock Current Preset", "Spacebar"},
        {"Toggle Shuffle", "y"},
        {"Toggle Fullscreen", "Ctrl+f, Right Mouse"},
        {"Toggle Aspect Correction", "a"},
        {"Save Current Preset to Save Path", "s"},
        {"Delete Current Preset from Save Path", "d"},
        {"Next Audio Input Device", "Ctrl+i"},
        {"Move to Next Monitor", "Ctrl+m"},
        {"Copy Current Preset Path to Clipboard", "Ctrl+c"},
        {"Increase Beat Sensitivity", "Cursor Up"},
        {"Decrease Beat Sensitivity", "Cursor Down"},
        {"Add Random Waveform at Mouse Pointer", "Shift+Left Mouse"},
        {"Clear All Waveforms", "Middle Mouse"}};
}
